...
export const Header = () => {
  ...
  const handelSearch = (e) => {
    e.preventDefault();
    const searchParams = e.target.search.value;
    e.target.reset();
    return navigate(`search/movie?q=${searchParams}`);
  };
      ...
      <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
        <div className="flex flex-wrap justify-between items-center mx-auto">
            ...
            <div className="hidden relative md:block">
              ...
              <form onSubmit={handelSearch}>
                <input
                  type="text"
                  id="search-navbar"
                  className="block p-2 pl-10 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mx"
                  placeholder="Search..."
                  name="search"
                />
              </form>
          ...
          <div
            className={`${
              hidden ? "hidden" : ""
            } justify-between items-center w-full md:flex md:w-auto md:order-1" id="navbar-search`}
          >
